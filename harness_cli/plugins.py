...
from harness_cli.middleware import OBSERVER_SCHEMA_VERSION, VALID_MIDDLEWARE
...
class PluginContext:
    ...
    def register_command(
        ...
        try:
            from harness_cli.commands import resolve_command
    ...
    def register_dashboard_auth_provider(self, provider) -> None:
        ...
        ``provider`` must be an instance of
        :class:`harness_cli.dashboard_auth.DashboardAuthProvider`. Used by
        ...
        """
        from harness_cli.dashboard_auth import (
    ...
    def register_auxiliary_task(
        ...
        *,
        ...
        # Lazy import to avoid circular: harness_cli.main imports plugins indirectly
        from harness_cli.main import _AUX_TASKS as _BUILTIN_AUX_TASKS
...
class PluginManager:
    ...
    def discover_and_load(self, force: bool = False) -> None:
        ...
        user_dir = get_harness_home() / "plugins"
