...
def _inherited_flag(parser, *args, **kwargs):
    """Register a flag that ``harness_cli.relaunch`` should carry over when
...
def build_top_level_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="hermes",
        description="Harness Agent - AI assistant with tool-calling capabilities",
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive chat session with Harness Agent",
    )
