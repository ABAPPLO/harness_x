...
def _hermes_home_path() -> Path:
    ...
    try:
        from harness_constants import get_harness_home  # local import to avoid cycles
...
def _hermes_root_path() -> Path:
    ...
    try:
        from harness_constants import get_default_harness_root  # local import to avoid cycles
        return get_default_harness_root()
    except Exception:
        return Path(os.path.expanduser("~/.hermes"))
