...
Run with: python -m agent.transports.harness_tools_mcp_server
...
def _build_server() -> Any:
    ...
    mcp = FastMCP(
        "hermes-tools",
        instructions=(
            "Harness Agent's tool surface, exposed for use inside a Codex "
...
def main(argv: Optional[list[str]] = None) -> int:
    """Entry point for `python -m agent.transports.harness_tools_mcp_server`."""
