...
from harness_constants import PARTIAL_STREAM_STUB_ID
from harness_logging import set_session_context
...
def _restore_or_build_system_prompt(agent, system_message, conversation_history):
    ...
    try:
        from harness_cli.plugins import invoke_hook as _invoke_hook
        _invoke_hook(
            "on_session_start",
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                try:
                    from harness_cli.middleware import apply_llm_request_middleware
                ...
                try:
                    from harness_cli.plugins import (
                        has_hook,
                ...
                from harness_cli.middleware import run_llm_execution_middleware
                ...
                if (
                    ...
                    from harness_constants import display_harness_home as _dhh_fn
                    _dhh = _dhh_fn()
                    _body_text = ""
                    try:
