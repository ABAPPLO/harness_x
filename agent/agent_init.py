...
from harness_cli.config import cfg_get
from harness_cli.timeouts import get_provider_request_timeout
...
def init_agent(
    ...
    try:
        from harness_cli.model_normalize import (
    ...
    agent._cache_ttl = "5m"
    try:
        from harness_cli.config import load_config as _load_pc_cfg
    ...
    from harness_logging import setup_logging, setup_verbose_logging
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        if _is_bedrock_anthropic:
            ...
            if agent.provider == "minimax-oauth" and isinstance(effective_key, str) and effective_key:
                try:
                    from harness_cli.auth import build_minimax_oauth_token_provider
        ...
        try:
            from harness_cli.config import load_config as _load_br_cfg
    ...
    try:
        from harness_cli.config import load_config as _load_sess_cfg
    ...
    try:
        from harness_cli.config import load_config as _load_agent_config
            ...
            if _mem_provider_name and _mem_provider_name.strip():
                ...
                if agent._memory_manager.providers:
                    _init_kwargs = {
                        ...
                        "hermes_home": str(get_harness_home()),
                    ...
                    try:
                        from harness_cli.profiles import get_active_profile_name
    ...
    try:
        from harness_cli.config import get_compatible_custom_providers
    ...
    if _config_context_length is None and _custom_providers:
        try:
            from harness_cli.config import get_custom_provider_context_length
    ...
    if _engine_name != "compressor":
        ...
        if _selected_engine is None:
            try:
                from harness_cli.plugins import get_plugin_context_engine
    ...
    if _ctx and _ctx < MINIMUM_CONTEXT_LENGTH:
        raise ValueError(
            ...
            f"by Harness Agent.  Choose a model with at least "
