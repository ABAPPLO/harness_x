...
Plugins built on Harness Agent often need to make their own LLM calls
...
:class:`~harness_cli.plugins.PluginContext`:
...
class PluginLlm:
    ...
    Instances are constructed by :class:`harness_cli.plugins.PluginContext`
