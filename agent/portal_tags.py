...
Nous can attribute usage to Harness Agent and bucket it by client release.
...
The version is sourced live from ``harness_cli.__version__`` so it auto-aligns
...
``harness_cli.__version__`` is the canonical source of truth.
"""
...
def nous_portal_tags() -> List[str]:
    ...
    """
    return ["product=hermes-agent", harness_client_tag()]
