...
from harness_constants import OPENROUTER_MODELS_URL
...
# Minimum context length required to run Harness Agent.  Models with fewer
...
def _get_context_cache_path() -> Path:
    ...
    return get_harness_home() / "context_length_cache.yaml"
...
def get_model_context_length(
    ...
    if effective_provider in {"copilot", "copilot-acp", "github-copilot"}:
        try:
            from harness_cli.models import get_copilot_model_context
