...
def switch_model(agent, new_model, new_provider, api_key='', base_url='', api_mode=''):
    ...
    turn-scoped).
    """
    from harness_cli.providers import determine_api_mode
    ...
    if hasattr(agent, "context_compressor") and agent.context_compressor:
        ...
        try:
            from harness_cli.config import load_config, get_compatible_custom_providers
            _sm_cfg = load_config()
...
def invoke_tool(agent, function_name: str, function_args: dict, effective_task_id: str,
    ...
    try:
        from harness_cli.middleware import apply_tool_request_middleware
    ...
    if not pre_tool_block_checked:
        try:
            from harness_cli.plugins import get_pre_tool_call_block_message
    ...
    if function_name == "todo":
        ...
        def _execute(next_args: dict) -> Any:
            ...
            if not session_db:
                from harness_state import format_session_db_unavailable
    ...
    from harness_cli.middleware import run_tool_execution_middleware
