...
TOOLSETS = {
    ...
    "hermes-webhook": {
        ...
        "tools": _HARNESS_WEBHOOK_SAFE_TOOLS,
        "includes": []
    },
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    if not toolset:
        ...
        # Gives them _HARNESS_CORE_TOOLS plus any tools the plugin registered
        ...
        if name.startswith("hermes-"):
            ...
            try:
                ...
                if platform_registry.is_registered(platform_name):
                    plugin_tools = set(_HARNESS_CORE_TOOLS)
                    try:
                        from tools.registry import registry
                        plugin_tools.update(
