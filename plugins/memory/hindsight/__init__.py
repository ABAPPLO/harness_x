...
def _load_config() -> dict:
    ...
    profile_path = get_harness_home() / "hindsight" / "config.json"
...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        from harness_cli.config import save_config
        from harness_cli.secret_prompt import masked_secret_prompt

        from harness_cli.memory_setup import _curses_select
