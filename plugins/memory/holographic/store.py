...
class MemoryStore:
    ...
    def __init__(
        ...
        if db_path is None:
            ...
            db_path = str(get_harness_home() / "memory_store.db")
    ...
    def _init_db(self) -> None:
        ...
        # state.db / kanban.db — see harness_state._WAL_INCOMPAT_MARKERS).
        from harness_state import apply_wal_with_fallback
