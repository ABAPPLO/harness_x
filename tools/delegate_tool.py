...
# Must match harness_cli.runtime_provider.RUNTIME_PROVIDER_TYPE_CUSTOM.
...
def _build_child_agent(
    ...
    try:
        ...
        if delegation_effort:
            from harness_constants import parse_reasoning_effort
...
def _resolve_delegation_credentials(cfg: dict, parent_agent) -> dict:
    ...
    if configured_base_url:
        ...
        from harness_cli.runtime_provider import _detect_api_mode_for_url
