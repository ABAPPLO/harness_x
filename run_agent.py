...
from harness_cli.env_loader import load_hermes_dotenv
from harness_cli.timeouts import (
    get_provider_request_timeout,
    get_provider_stale_timeout,
)

_hermes_home = get_harness_home()
...
# browser_tool removed in harness_x — stub for cleanup compatibility
def cleanup_browser():
    pass
...
def _routermint_headers() -> dict:
    ...
    return {
        "User-Agent": f"HermesAgent/{_HARNESS_VERSION}",
    }
...
class AIAgent:
    ...
    def _get_session_db_for_recall(self):
        ...
        try:
            from harness_state import SessionDB
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        ...
        try:
            ...
            from harness_cli.models import ensure_lmstudio_model_loaded
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        # ``monkeypatch.setattr("harness_cli.plugins.has_hook", ...)`` still
        ...
        try:
            from harness_cli import plugins as _plugins
    ...
    def _file_mutation_verifier_enabled(self) -> bool:
        ...
        try:
            ...
            try:
                from harness_cli.config import load_config as _load_config
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from harness_cli.copilot_auth import resolve_copilot_token
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
                from harness_cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from harness_cli.models import lmstudio_model_reasoning_options
